...
public class Quiz {
    ...
    // Using a single class-level Scanner prevents input-blocking issues
    ...
    public ArrayList<Double> q4(ArrayList<Double> Scores) {
        ...
        if (answer >= 1) {
            Scores.set(4, Scores.get(4) + 1); // Rodent
    ...
    public ArrayList<Double> q6(ArrayList<Double> Scores) {
        ...
        if (answer == 1) {
            Scores.set(2, Scores.get(2) - 4); // Fixed typo here 
            ...
            // Added tier for progressive scaling
            Scores.set(1, Scores.get(1) - 4);
            Scores.set(4, Scores.get(4) - 4);
    ...
    public ArrayList<Double> q8(ArrayList<Double> Scores) {
        ...
        while (true) {
            String ans = input.nextLine().trim(); // Fixed: Added missing ans declaration
            if (ans.length() == 1 && Character.isDigit(ans.charAt(0))) {
                answer = Integer.parseInt(ans);
    ...
    public ArrayList<Double> q10(ArrayList<Double> Scores) {
        ...
        if (answer == 1) {
            Scores.set(0, Scores.get(0) - 10); // Dogs need a lot of exercise
        } else if (answer == 2) {
            Scores.set(0, Scores.get(0) - 8);  // Added missing tier
        } else if (answer == 3) {
            Scores.set(0, Scores.get(0) - 6);
        }
        return Scores;
